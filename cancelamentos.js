...
const CANC = (function(){
  ...
  async function carregar(reset){ if(reset)PAGINA=0; f('tbody').innerHTML='<tr><td colspan="21" class="loading">Carregando cancelamentos…</td></tr>'; const fl=filtros();
  ...
  function renderTabela(){ const tb=f('tbody'); if(!LINHAS.length){ tb.innerHTML='<tr><td colspan="21" class="empty">Nenhum cancelamento encontrado.</td></tr>'; return; }
